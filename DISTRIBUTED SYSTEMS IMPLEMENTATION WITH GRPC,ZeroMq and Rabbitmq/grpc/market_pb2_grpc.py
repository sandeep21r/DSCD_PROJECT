...
class MarketServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BuyItem = channel.unary_unary(
                ...
                response_deserializer=market__pb2.BuyResponse.FromString,
                )
        ...
        self.SellItem = channel.unary_unary(
                ...
                response_deserializer=market__pb2.ItemResponse.FromString,
                )
        ...
        self.DisplaySellerItems = channel.unary_unary(
                ...
                request_serializer=market__pb2.DisplayItemsRequest.SerializeToString,
                response_deserializer=market__pb2.DisplayItemsResponse.FromString,
                )
...
def add_MarketServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BuyItem': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=market__pb2.BuyResponse.SerializeToString,
            ),
            ...
            'SellItem': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=market__pb2.ItemResponse.SerializeToString,
            ),
            ...
            'DisplaySellerItems': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=market__pb2.DisplayItemsRequest.FromString,
                    response_serializer=market__pb2.DisplayItemsResponse.SerializeToString,
            ),
    }
...
class MarketService(object):
    ...
    def BuyItem(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/MarketService/BuyItem',
            ...
            market__pb2.BuyResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SellItem(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/MarketService/SellItem',
            ...
            market__pb2.ItemResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DisplaySellerItems(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/MarketService/DisplaySellerItems',
            market__pb2.DisplayItemsRequest.SerializeToString,
            market__pb2.DisplayItemsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
